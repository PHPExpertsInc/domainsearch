...
class NameCheapAPI_Sandbox_DomainAvailablility extends NameCheapAPI_DomainAvailablility implements Interface_DomainAvailability
{
	const API_CHECKDOMAIN_FORMAT = 'https://api.sandbox.namecheap.com/xml.response?ApiUser={username}&ApiKey={apiKey}&UserName={username}&clientIp={ipAddress}&Command=namecheap.domains.check&DomainList={domainList}';
}
