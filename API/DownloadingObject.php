...
abstract class API_DownloadingObject
{
	/** @var Model_APIAccessCredentials */
	protected $accessCreds;

	/** @var Thrive_URL_Downloader */
	protected $downloader;

	public function __construct(Model_APIAccessCredentials $accessCreds, Thrive_URL_Downloader $downloader = null, $memcache = null)
	{
		$this->accessCreds = $accessCreds;
	...
	protected function transformURL($url, $params)
	{
		$transformedURL = str_replace(array_keys($params), $params, $url);
